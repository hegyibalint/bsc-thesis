...
The compilation workflow is aided by the \verb+make+ utility. While the support libraries' makefile is written for Linux systems, it's compatible and was tested on \osx version \verb|10.11.4|.
